 ...
 */
class Version20180509190735 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment ADD recipe VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP recipe_id');
    }
}
